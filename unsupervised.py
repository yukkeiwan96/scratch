...
numcol=int(sys.argv[2])   #input the number of columns in the dataset
...
Dlist= preSpam(dat)
#Dlist= preIris(dat,F)[0]
#Dlist= preGlass(dat,F)[0]
...
runKmeans=kmeans(Dlist[55],2)
centrioles=runKmeans[0]
clusters=runKmeans[1]
